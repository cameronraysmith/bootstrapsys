#!/bin/bash
#
# install common software in ubuntu
...
# Install python packages with pip from pypack.txt file
pip install -r pypack.txt
...
## Install dotfiles.
#git clone git@github.com:uname/dotfiles.git ~/.dotfiles
